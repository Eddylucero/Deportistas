    ...
    <div class="row justify-content-center">
      <div class="col-md-10 col-lg-8 p-3 py-5 ftco-animate">
        <div class="bg-light p-4 rounded shadow" 
             style="background-color: rgba(255, 255, 255, 0.95); border-radius: 16px;">
          
          <h2 class="mb-4 text-center text-dark">
            <span class="text-warning me-2"></span> Editar Disciplina
          </h2>

          <form action="{{ route('disciplinas.update', $disciplina->iddisciplina) }}" 
                id="FormDisciplina" method="post">
            @csrf
            @method('PUT')
            ...
            <div class="row">
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <input type="text" name="nombredisciplina" id="nombredisciplina" 
                         ...
                         value="{{ old('nombredisciplina', $disciplina->nombredisciplina) }}"
              ...
              <div class="col-md-12 text-center mt-4">
                <a href="{{ route('disciplinas.index') }}" 
                   class="btn btn-outline-danger me-3 rounded">
